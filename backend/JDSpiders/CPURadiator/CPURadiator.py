...
class JDCPURadiatorSpider:
  ...
  def __init__(self):
    ...
    query = "truncate table cpu_radiator"
  ...
  def CPURadiatorSpider(self):
    ...
    for url in start_urls:
      ...
      for i in range(60):
        ...
        # print(shop_name)
        # exit(0)
        cpu_radiator_urls.append(url_tmp)
        # 获得 price
        try:
        ...
        try:
          ...
          print(price)
          continue
        cpu_radiator_prices.append(price)
        # print(price)
        # exit(0)
      # print(len(cpu_radiator_urls))
      # print(len(cpu_radiator_prices))
      # print(len(shop_names))
      # pprint(cpu_radiator_urls)
      # pprint(cpu_radiator_prices)
      # pprint(shop_names)
      # exit(0)
      self.valid_urls.append(len(cpu_radiator_urls))
      # 进入每个商品的页面，逐一访问
      for i in range(len(cpu_radiator_urls)):
        link = cpu_radiator_urls[i]
        price = cpu_radiator_prices[i]
  ...
  def insertJDData(self, name, comment_num, praise_rate, shop_name, price, link,
    ...
    '''
    description: Insert data into table ** cpu_radiator **
    '''
    ...
    sql_insert = "INSERT INTO cpu_radiator (name, comment_num, praise_rate, shop_name, price, link,"\
